...
<%
    ...
    try {
        ...
        String error =
                URLEncoder.encode(AuthenticationEndpointUtil.i18n(resourceBundle, "internal.error.occurred"),"utf-8");
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        <%=AuthenticationEndpointUtil.i18n(resourceBundle, "user.details.submitted.successfully")%>
                    </p>
                </div>
