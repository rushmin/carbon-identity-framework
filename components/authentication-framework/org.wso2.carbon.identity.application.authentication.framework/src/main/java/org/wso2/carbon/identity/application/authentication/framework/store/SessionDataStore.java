...
public class SessionDataStore {
    ...
    private static final String SQL_DESERIALIZE_OBJECT_MSSQL =
            "SELECT TOP 1 OPERATION, SESSION_OBJECT, TIME_CREATED FROM IDN_AUTH_SESSION_STORE WITH (NOLOCK) WHERE " +
                    "SESSION_ID =? AND SESSION_TYPE=? ORDER BY TIME_CREATED DESC";
