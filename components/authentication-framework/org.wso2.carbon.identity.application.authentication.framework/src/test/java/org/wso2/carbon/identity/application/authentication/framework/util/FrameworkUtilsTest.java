...
public class FrameworkUtilsTest extends PowerMockTestCase {
    ...
    public Object[][] provideInvalidData() {
        ...
        map1.put(FrameworkConstants.Config.QNAME_EXT_AUTHORIZATION_HANDLER, testPostAuthenticationHandler);

        Map<String, Object> map2 = new HashMap<>();
        map2.put(FrameworkConstants.Config.QNAME_EXT_POST_AUTHENTICATION_HANDLER, testPostAuthenticationHandler);

        Map<String, Object> map3 = new HashMap<>();
        map3.put(FrameworkConstants.Config.QNAME_EXT_POST_AUTHENTICATION_HANDLER, new Object());
