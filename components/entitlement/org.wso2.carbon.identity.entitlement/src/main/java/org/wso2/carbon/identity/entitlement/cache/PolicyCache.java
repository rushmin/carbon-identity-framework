...
public class PolicyCache extends EntitlementBaseCache<IdentityCacheKey, PolicyStatus>{
    ...
    public void invalidateCache() {
        ...
        int tenantId = CarbonContext.getThreadLocalCarbonContext().getTenantId();
        if (log.isDebugEnabled()) {
            log.debug("Trigger invalidatePolicyCache to tenant :  " + tenantId + " and all policy ");
        }
    ...
    public void invalidateCache(String policyId, String action) {
        ...
        if (log.isDebugEnabled()) {
            log.debug("Trigger invalidatePolicyCache to tenant :  " + tenantId + " and policy " + policyId + " for  action " +
                    ": " + action);
        }
